  ...
  const handleDelete = async (
    ...
    try {
      ...
      await sendNotificationEmail(
        ...
        "Company Deleted",
        "Company Deleted",
        "Your company has been deleted. Please contact your administrator if you need to access your company again."
      );
              ...
              <tr key={company.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-left">
                  <div className="flex items-center justify-start gap-2">
                    ...
                    <button
                      onClick={() => handleDelete(company.id, company.admin_email || '', company.admin_name || '')}
