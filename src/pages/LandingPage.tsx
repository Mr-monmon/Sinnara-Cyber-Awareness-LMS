...
const FEATURES = [
  {
    title: "Hosted in Saudi Arabia",
    desc: "Full data residency and sovereignty within the Kingdom.",
  },
  {
    title: "Regulatory Compliance",
    desc: "Built for ISO 27001, NCA, SAMA, and PDPL frameworks.",
  },
  {
    title: "Local Threat Intel",
    desc: "Stay updated on threats specific to the MENA region.",
  },
  {
    title: "Comprehensive Training",
    desc: "In-depth interactive modules for all employee levels.",
  },
  {
    title: "Pre & Post Assessments",
    desc: "Accurately measure knowledge retention and ROI.",
  },
  {
    title: "Real-Time Analytics",
    desc: "Instant visibility into your organization's risk profile.",
  },
  {
    title: "Role-Based Access",
    desc: "Granular permissions for diverse administrative teams.",
  },
  {
    title: "Phishing Simulation",
    desc: "Test resilience with realistic regional attack vectors.",
  },
];
...
const STEPS = [
  {
    title: "Assess",
    desc: "Baseline your team's current security knowledge with intelligent pre-assessments.",
  },
  {
    title: "Train",
    desc: "Deliver localized, role-based training modules tailored to your industry.",
  },
  {
    title: "Simulate",
    desc: "Run realistic phishing simulations to test real-world readiness and response.",
  },
  {
    title: "Report",
    desc: "Gain actionable insights and compliance-ready reports to measure your ROI.",
  },
];
...
const StepIcons: React.ReactNode[] = [
  <svg key="s1" width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path
      d="M9 1L2 4V9C2 13.418 5.17 17.564 9 18C12.83 17.564 16 13.418 16 9V4L9 1Z"
      stroke="#c8ff00"
      strokeWidth="1.5"
  ...
  <svg key="s2" width="22" height="18" viewBox="0 0 22 18" fill="none">
    <path
      d="M1 1H7C8.06 1 9.08 1.42 9.83 2.17C10.58 2.92 11 3.94 11 5V17C11 16.2 10.68 15.44 10.12 14.88C9.56 14.32 8.8 14 8 14H1V1Z"
      stroke="#c8ff00"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
    <path
      d="M21 1H15C13.94 1 12.92 1.42 12.17 2.17C11.42 2.92 11 3.94 11 5V17C11 16.2 11.32 15.44 11.88 14.88C12.44 14.32 13.2 14 14 14H21V1Z"
      stroke="#c8ff00"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
...
export const LandingPage = () => {
    ...
    for (const kw of keywords) {
      if (text.includes(kw)) {
        ...
        return (
          <>
            {before}
            <span style={{ color: T.accent }}>{kw}</span>
            {after}
          </>
        );
      }
  ...
  return (
    ...
    >
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                cursor: "pointer",
                boxShadow: "0 0 20px rgba(200,255,0,0.30)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              pointerEvents: "none",
              background:
                "radial-gradient(ellipse at 50% 50%, rgba(200,255,0,0.15) 0%, rgba(200,255,0,0) 70%)",
            }}
          />
              ...
              >
                ...
                <div
                  style={{
                    ...
                    gap: 8,
                    padding: "5px 13px",
                    background: T.accentAlpha10,
                    border: `1px solid ${T.accentAlpha20}`,
                    borderRadius: 9999,
                    width: "fit-content",
                  }}
                >
                ...
                <div>
                  {[
                    ...
                    <p
                      key={i}
                      className="aw-hero-h"
                      style={{ color: i === 2 ? T.accent : T.white, margin: 0 }}
                    >
                      {line}
                    </p>
                  ))}
                ...
                >
                  AwareOne is a comprehensive cybersecurity awareness platform
                  designed to train, assess, and strengthen your organization's
                  security culture.
                </p>
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        textDecorationColor: "rgba(200,255,0,0.30)",
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                        padding: 0,
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(29.29deg, rgba(200,255,0,0.10) 0%, rgba(200,255,0,0) 50%)",
                        zIndex: 1,
                        pointerEvents: "none",
                      }}
                    />
                    <img
                      src={DASH}
                      alt="AwareOne cybersecurity dashboard"
                      style={{
                        width: "100%",
                        display: "block",
        ...
        <section id="how-it-works" className="aw-section">
          <div className="aw-container">
            ...
            <div style={{ textAlign: "center", marginBottom: 80 }}>
              ...
              >
                A structured, end-to-end approach to building a security-aware
                workforce.
              </p>
            </div>
            {/* Steps */}
          ...
          <div className="aw-container">
            ...
            >
              <div>
                ...
                >
                  Stay ahead of threats with expert-led cybersecurity research.
                </p>
              </div>
              <button
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 48 48"
                      fill="none"
                      style={{ color: "rgba(200,255,0,0.20)" }}
                    >
                      <rect
                        x="6"
                        y="8"
              ...
              <div className="aw-cta-btn-row">
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    lineHeight: "28px",
                    boxShadow: "0 0 30px rgba(200,255,0,0.30)",
                    transition: "opacity 0.2s, transform 0.15s",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.opacity = "0.9";
      ...
      ═══════════════════════════════════ */}
      <footer
        style={{ paddingTop: 80, borderTop: `1px solid ${T.borderFaint}` }}
      >
        <div className="aw-container">
          {/* Grid */}
