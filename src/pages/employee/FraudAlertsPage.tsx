...
if (
  ...
  !document.getElementById("aw-fa-dash-styles")
) {
...
export const FraudAlertsPage: React.FC = () => {
  ...
  const fetchAlerts = async () => {
    const { data: alertData, error } = await supabase
      .from("fraud_alerts")
      .select(
        "id, title, fraud_type, severity, internal_content, video_url, internal_steps, is_published"
      )
    ...
    if (!error && alertData && user) {
      ...
      setAlerts(
        alertData.map((a) => ({ ...a, acknowledged: ackSet.has(a.id) }))
      );
    }
    setLoading(false);
  };
        ...
        {total > 0 && (
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            {[
              ...
              >
                <span
                  style={{ fontSize: 18, fontWeight: 800, color: stat.color }}
                >
                  {stat.value}
                </span>
                <span
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      ...
                      <span className="aw-channel-tag">
                        ...
                        <strong style={{ color: T.textLabel }}>
                          {alert.fraud_type}
                        </strong>
                      </span>
                    </div>
                        ...
                        <>
                          <div
                            style={{
                              ...
                              height: 14,
                              borderRadius: "50%",
                              border: "2px solid rgba(18,20,10,0.30)",
                              borderTopColor: T.accentDark,
