...
if (
  ...
  !document.getElementById("aw-legal-acc-styles")
) {
    ...
    content: (
      <>
        <Sec n={1} title="About AwareOne">
          <p>
            AwareOne is a cybersecurity awareness SaaS platform helping
            organizations improve security through training, phishing
            simulations, assessments, and analytics.
          </p>
        </Sec>
        ...
        <Sec n={4} title="Data Storage">
          <p>
            AwareOne uses secure cloud infrastructure. Some data may be stored
            through providers whose servers are located outside the Kingdom of
            Saudi Arabia. Appropriate safeguards are implemented in such cases.
          </p>
        </Sec>
        ...
        <Sec n={6} title="Data Sharing">
          <p>
            AwareOne does <strong>not sell or rent personal data</strong>.
            Information is shared only with trusted service providers, when
        ...
        <Sec n={8} title="Contact">
          <p>
            Questions? <strong>support@awareone.net</strong>
          </p>
        </Sec>
      </>
    ),
    ...
    content: (
      <>
        <Sec n={1} title="Eligibility">
          <Bullets
            items={[
              ...
              "Must have authority to represent your organization",
        ...
        <Sec n={2} title="Account Registration">
          <Bullets
            items={[
              ...
              "Notify AwareOne immediately of unauthorized access",
            ]}
          />
        </Sec>
        ...
        <Sec n={4} title="Phishing Simulation">
          <p>
            Simulations are for <strong>educational purposes only</strong>,
            limited to users within the Customer's organization, and must comply
            with internal policies where required.
          </p>
        </Sec>
        <Sec n={5} title="Prohibited Use">
          <Bullets
            items={[
              ...
              "Malicious phishing outside authorized testing",
        ...
        <Sec n={6} title="Intellectual Property">
          <p>
            All platform content is the intellectual property of AwareOne. Users
            receive a{" "}
            <strong>limited, non-exclusive, non-transferable license</strong>{" "}
            for intended use only.
          </p>
        </Sec>
        <Sec n={7} title="Limitation of Liability">
          <p>
            AwareOne shall not be liable for indirect or consequential damages,
            loss of business or data, or damages resulting from user misuse.
          </p>
        </Sec>
        <Sec n={8} title="Contact">
          <p>
    ...
    content: (
      <>
        <Sec n={1} title="Security Principles">
          ...
          <h3>Integrity</h3>
          <p>
            Ensuring data remains accurate and protected from unauthorized
            modification.
          </p>
          <h3>Availability</h3>
          <p>
            Maintaining reliable platform access and minimizing service
            disruptions.
          </p>
        </Sec>
        ...
        <Sec n={4} title="Access Control">
          <p>
            Access is restricted to authorized personnel only, based on the{" "}
            <strong>principle of least privilege</strong>. Administrative access
        ...
        <Sec n={6} title="Reporting Security Issues">
          <p>
            Discovered a vulnerability? Contact our security team at{" "}
            <strong>support@awareone.net</strong>
          </p>
        </Sec>
      </>
    ),
      ...
      <>
        <Sec n={1} title="Authorized Use">
          <Bullets
            items={[
              ...
              "Conducting controlled phishing simulations within the organization",
              "Measuring employee security awareness levels",
        ...
        <Sec n={2} title="Phishing Simulation Rules">
          <p>
            ...
            <strong>only within the user's organization</strong>, used solely
            for awareness training, and must not cause harm, panic, or
            disruption.
          </p>
        </Sec>
        <Sec n={3} title="Prohibited Activities">
          <Bullets
            items={[
              "Real phishing attacks or cybercrime",
              "Distributing malware, ransomware, or harmful software",
              "Targeting individuals outside authorized testing",
              "Unauthorized access to systems or networks",
              "Interfering with platform operation or security",
              "Reverse engineering or copying the platform",
            ]}
          />
        </Sec>
        <Sec n={4} title="Organization Responsibilities">
          <Bullets
            items={[
              "Managing user access within accounts",
              "Ensuring employees are informed of awareness initiatives",
    ...
    content: (
      <>
        <Sec n={1} title="What Are Cookies">
          <p>
            Cookies are small data files stored on your device that help the
            platform recognize users, maintain sessions, and improve
            performance.
          </p>
        </Sec>
        ...
        <Sec n={3} title="Types of Cookies">
          ...
          <p>
            Required for authentication, session management, and navigation.
          </p>
          <h3>Performance & Analytics Cookies</h3>
          <p>
            Collect anonymous usage information to help improve the platform.
          </p>
    ...
    content: (
      <>
        <Sec n={1} title="Roles of the Parties">
          <p>
            The <strong>Customer acts as the Data Controller</strong>.{" "}
            <strong>AwareOne acts as the Data Processor</strong>, processing
            personal data only on behalf of the Customer.
          </p>
        </Sec>
        <Sec n={2} title="Scope of Processing">
          <Bullets
            items={[
              ...
              "Department or role information",
              "Training participation data",
              "Phishing simulation interaction results",
        ...
        <Sec n={3} title="Confidentiality">
          <p>
            All personnel involved in processing are bound by confidentiality
            obligations and have access only where necessary to perform their
            duties.
          </p>
        </Sec>
        ...
        <Sec n={5} title="Sub-Processors">
          <p>
            AwareOne may engage trusted third-party providers for
            infrastructure, storage, and monitoring. Some data may transit
            through servers outside the Kingdom of Saudi Arabia, with
            appropriate safeguards implemented.
          </p>
        </Sec>
        <Sec n={6} title="Data Breach Notification">
          <p>
            In the event of a confirmed personal data breach, AwareOne will
            notify the Customer without undue delay and provide reasonable
            assistance.
          </p>
        </Sec>
        <Sec n={7} title="Data Retention & Deletion">
          <p>
            Personal data is retained only as long as necessary. Upon
            termination, the Customer may request export or deletion of their
...
export const LegalPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span style={{ fontWeight: 900, fontSize: 15, color: T.white }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <button className="aw-nav-link" onClick={() => navigate("/login")}>
              Login
            </button>
            <button
              onClick={() => navigate("/")}
      ...
      >
        <div
          ...
          style={{
            ...
            height: 280,
            background:
              "radial-gradient(ellipse, rgba(200,255,0,0.07) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          Everything you need to know about how AwareOne operates, protects your
          data, and governs platform use. Click any document below to expand.
        </p>
      </div>
      ...
      >
        {POLICIES.map((policy, idx) => {
          ...
          return (
            <div
              key={policy.id}
              className={`aw-accord-card aw-fade-up ${isOpen ? "open" : ""}`}
              style={{ animationDelay: `${idx * 0.05}s` }}
            >
              {/* TRIGGER */}
              <button
                className="aw-accord-trigger"
              ...
              >
                <div
                  style={{
                    ...
                    border: `1px solid ${policy.color}22`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    transition: "box-shadow 0.25s",
                    boxShadow: isOpen ? `0 0 16px ${policy.color}18` : "none",
                  }}
                >
                  <Icon
                    size={19}
                    style={{
                      color: isOpen ? policy.color : `${policy.color}88`,
                    }}
                  />
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <span
                    style={{
                      fontSize: 15,
                      fontWeight: 700,
                      color: isOpen ? T.white : T.textLabel,
                      display: "block",
                      marginBottom: 3,
                    }}
                  >
                ...
                >
                  ...
                  >
                    <p style={{ fontSize: 12, color: T.textBody }}>
                      Last Updated:{" "}
                      <strong style={{ color: T.textLabel }}>2026</strong> ·
                      Contact:{" "}
                      <strong style={{ color: T.accent }}>
                        support@awareone.net
                      </strong>
                    </p>
                  </div>
                  {policy.content}
        ...
        >
          <p style={{ fontSize: 14, color: T.textBody, marginBottom: 14 }}>
            Have questions about our legal documents or data practices?
          </p>
          <a
            href="mailto:support@awareone.net"
            style={{
              display: "inline-flex",
              alignItems: "center",
              gap: 8,
              ...
              textDecoration: "none",
              fontFamily: "inherit",
              boxShadow: "0 0 18px rgba(200,255,0,0.18)",
              transition: "opacity 0.2s",
            }}
            onMouseEnter={(e) => (e.currentTarget.style.opacity = "0.88")}
            onMouseLeave={(e) => (e.currentTarget.style.opacity = "1")}
      ...
      {/* FOOTER */}
      <footer
        style={{ background: "#0a0c06", borderTop: `1px solid ${T.border}` }}
      >
        <div
          style={{
            maxWidth: 1100,
        ...
        >
          ...
          >
            <div>
              ...
              >
                ...
                />
                <span style={{ fontWeight: 900, fontSize: 14, color: T.white }}>
                  AWARE<span style={{ color: T.accent }}>ONE</span>
                </span>
              </div>
              <p
              ...
              >
                Cybersecurity awareness platform for the MENA region.
              </p>
              <div style={{ display: "flex", gap: 7 }}>
                {[Linkedin, Twitter, Youtube].map((Icon, i) => (
                  <a key={i} href="#" className="aw-social">
                    <Icon size={13} />
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              {[
                ...
                ["Fraud Alerts", "fraud-alerts"],
                ["Resources", "resources"],
                ["Free Assessment", "public-assessment"],
                ["Login", "login"],
              ].map(([l, p]) => (
          ...
          >
            <p style={{ fontSize: 12, color: T.textMuted }}>
              © 2025 AwareOne. All rights reserved.
            </p>
