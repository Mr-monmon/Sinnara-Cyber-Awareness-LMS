...
if (
  ...
  !document.getElementById("aw-pa-styles")
) {
  ...
  const getPerf = () => {
    ...
    if (pct >= 50)
      return {
        ...
        bdr: "rgba(250,204,21,0.25)",
      };
    return {
      level: "Needs Improvement",
      color: "#f87171",
      bg: "rgba(248,113,113,0.10)",
      bdr: "rgba(248,113,113,0.25)",
    };
  };
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: "0 0 10px rgba(200,255,0,0.40)",
                }}
              />
            </div>
          </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${
                        sel ? "rgba(200,255,0,0.40)" : T.borderFaint
                      }`,
                      borderRadius: 10,
                      cursor: "pointer",
                      display: "flex",
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontSize: 14,
                  fontWeight: 600,
                  color: currentQ === 0 ? T.textMuted : T.textBody,
              ...
              {isLast ? (
                <button
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.opacity = answered ? "1" : "0.5";
                    e.currentTarget.style.transform = "none";
                  }}
                >
    ...
    const recs =
      percentage >= 90
        ...
        ? [
            ...
            "Practice identifying phishing and social engineering attempts",
          ]
        : [
            "Consider enrolling in comprehensive cybersecurity training",
            "Review basic security concepts and best practices",
            "Stay updated on the latest regional security threats",
          ];
          ...
          >
            ...
            <div
              style={{
                ...
                margin: "0 auto 28px",
                background: perf.bg,
                border: `2px solid ${perf.bdr}`,
                display: "flex",
                flexDirection: "column",
                alignItems: "center",
                justifyContent: "center",
                boxShadow: `0 0 32px ${perf.bg}`,
              }}
            >
              <span
                style={{
            ...
            <p style={{ fontSize: 15, color: T.textBody, margin: "0 0 20px" }}>
              You scored <strong style={{ color: T.white }}>{score}</strong> out
              of <strong style={{ color: T.white }}>{total}</strong> correctly.
            </p>
            ...
            <div
              style={{
                ...
                borderRadius: 9999,
                background: perf.bg,
                border: `1px solid ${perf.bdr}`,
                marginBottom: 32,
              }}
            >
              <span
                style={{ fontSize: 15, fontWeight: 700, color: perf.color }}
              >
                {perf.level}
              </span>
            </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        marginTop: 7,
                        flexShrink: 0,
                        boxShadow: "0 0 6px rgba(200,255,0,0.50)",
                      }}
                    />
                    {rec}
                  </li>
