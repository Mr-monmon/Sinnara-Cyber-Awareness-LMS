...
export const EmployeeDetailPage: React.FC<EmployeeDetailPageProps> = ({
  ...
  const generateReport = () => {
    ...
    const improvement =
      employee.pre_assessment_score && employee.post_assessment_score
        ? (
            ((employee.post_assessment_score - employee.pre_assessment_score) /
              employee.pre_assessment_score) *
            100
          ).toFixed(1)
        : "N/A";
...
`
  ...
  .join("\n")}
    ...
    link.href = url;
    link.download = `employee_report_${employee.full_name.replace(
      /\s+/g,
      "_"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
        ...
        {employee.phone && (
          <p className="text-blue-100 mb-1">{employee.phone}</p>
        )}
        {employee.employee_id && (
          <p className="text-blue-100 mb-1">ID: {employee.employee_id}</p>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">
                  {employee.post_assessment_score?.toFixed(1) ||
                    "Not completed"}
                  %
                </p>
                {employee.post_assessment_date && (
...
//   "code": "42703",
//   "details": null,
//   "hint": "Perhaps you meant to reference the column \"issued_certificates.issued_at\".",
//   "message": "column issued_certificates.issue_date does not exist"
// }
