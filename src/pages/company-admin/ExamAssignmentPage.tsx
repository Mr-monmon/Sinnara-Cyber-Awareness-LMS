      ...
      rawData.map(async (a) => {
        ...
        return {
          ...
          assigned_to_employee: a.assigned_to_employee
            ? usersMap.get(a.assigned_to_employee) || null
            : null,
          assigned_to_department: a.assigned_to_department
            ? deptsMap.get(a.assigned_to_department) || null
            : null,
        };
      })
    );
      ...
      if (insertError) {
        setError(
          insertError.code === "23505"
            ? "This exam is already assigned to the selected target."
            : "Failed to assign exam: " + insertError.message
        );
        return;
      }
      setShowModal(false);
